<?php
    include('scripts.php');
	$data = getTasks();
	$in_progress_data = array_filter($data,function($task){
		return $task['status'] == 'In Progress';
	});
	$to_do_data = array_filter($data,function($task){
		return $task['status'] == 'To Do';
	});
	$done_data = array_filter($data,function($task){
		return $task['status'] == 'Done';
	});

	$to_do_task_count = count($to_do_data);
	$in_progress_task_count = count($in_progress_data);
	$done_task_count = count($done_data);
		...
		<div id="content" class="app-content" style="min-height: 100vh; background: url(assets/img/cover/cover-scrum-board.png) no-repeat fixed; background-size: 360px; background-position: right bottom;">
			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">To do (<span id="to-do-tasks-count"><?php echo $to_do_task_count?></span>)</h4>
							...
							<!-- TO DO TASKS HERE -->
								...
								<div class='d-flex justify-content-between'>
									<div class=''>
										...
										<span class='btn btn-secondary btn-xs' data-value='$priority_id' id='priority-$id'>${priority}</span>
									</div>
								</div>
								</div>
								</button>"
				...
				<div class="col-xl-4 col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">In Progress (<span id="in-progress-tasks-count"><?php echo $in_progress_task_count; ?></span>)</h4>
							<div class="panel-heading-btn">
								<a href="javascript:;" class="btn btn-xs btn-icon btn-default" data-toggle="panel-expand"><i class="fa fa-expand"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-success" data-toggle="panel-reload"><i class="fa fa-redo"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-warning" data-toggle="panel-collapse"><i class="fa fa-minus"></i></a>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Done (<span id="done-tasks-count"><?php echo $done_task_count ?></span>)</h4>
							<div class="panel-heading-btn">
								<a href="javascript:;" class="btn btn-xs btn-icon btn-default" data-toggle="panel-expand"><i class="fa fa-expand"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-success" data-toggle="panel-reload"><i class="fa fa-redo"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-warning" data-toggle="panel-collapse"><i class="fa fa-minus"></i></a>
				...
				<form action="scripts.php" method="POST" id="form-task">
					...
					<div class="modal-body">
							...
							<div class="mb-3">
								...
								<select class="form-select" id="task-priority" name="task_priority" >
							...
							<div class="mb-3">
								...
								<select class="form-select" id="task-status" name="status_option">
									<option value="">Please select</option>
							...
							<div class="mb-3">
								...
								<input type="date" class="form-control" id="task-date" name="task_date"/>
							</div>
							<div class="mb-0">
								<label class="form-label">Description</label>
								<textarea class="form-control" rows="10" id="task-description" name="task_description"></textarea>
							</div>
